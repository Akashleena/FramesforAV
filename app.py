...
from bev_utils import generate_bev_animation

from scene_vqa import SceneFrame, answer, summarize_scene

# Import the reasoning pipeline
from nuscenes_reasoning_pipeline import extract_scene_context, chatgpt_reasoning
...
# Streamlit App
# ------------------------
st.title("NuScenes Visual Question Answering (VQA) + Reasoning")
...
# New Reasoning Q&A
# ------------------------
if st.button("Generate BEV Animation"):
    with st.spinner("Generating BEV animation..."):
        gif_path = generate_bev_animation(nusc, scene_index)
        st.image(gif_path, caption="BEV Animation", use_container_width=True)
